...
@section('content')
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="trainer-item">
                        <div class="image-thumb">
                            <img src="{{ asset('car/images/product-1-720x480.jpg') }}" alt="">
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="trainer-item">
                        <div class="image-thumb">
                            <img src="{{ asset('car/images/product-2-720x480.jpg') }}" alt="">
                        </div>
                        <div class="down-content">
                            <span>
                                <del><sup>$</sup>11999 </del> &nbsp; <sup>$</sup>11779
                ...
                <div class="col-lg-4">
                    <div class="trainer-item">
                        <div class="image-thumb">
                            <img src="{{ asset('car/images/product-3-720x480.jpg') }}" alt="">
                        </div>
                        <div class="down-content">
                            <span>
                                <del><sup>$</sup>11999 </del> &nbsp; <sup>$</sup>11779
    ...
    <section class="section section-bg" id="schedule" style="background-image: url('{{ asset('car/images/about-fullscreen-1-1920x700.jpg') }}')">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
            ...
            <div class="row" id="tabs">
                ...
                <div class="col-lg-8">
                    <section class='tabs-content'>
                        <article id='tabs-1'>
                            <img src="{{ asset('car/images/blog-image-1-940x460.jpg') }}" alt="">
                        ...
                        <article id='tabs-2'>
                            <img src="{{ asset('car/images/blog-image-2-940x460.jpg') }}" alt="">
                        ...
                        <article id='tabs-3'>
                            <img src="{{ asset('car/images/blog-image-3-940x460.jpg') }}" alt="">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <ul class="features-items">
                        <li class="feature-item">
                            <div class="left-icon">
                                <img src="{{ asset('car/images/features-first-icon.png') }}" alt="First One">
                            </div>
                        ...
                        <li class="feature-item">
                            <div class="left-icon">
                                <img src="{{ asset('car/images/features-first-icon.png') }}" alt="second one">
                            </div>
                            <div class="right-content">
                                <h4>John Doe</h4>
                                <p><em>"Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dicta numquam maxime voluptatibus, impedit sed! Necessitatibus repellendus sed deleniti id et!"</em></p>
                ...
                <div class="col-lg-6">
                    <ul class="features-items">
                        <li class="feature-item">
                            <div class="left-icon">
                                <img src="{{ asset('car/images/features-first-icon.png') }}" alt="fourth muscle">
                            </div>
                            <div class="right-content">
                                <h4>John Doe</h4>
                                <p><em>"Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dicta numquam maxime voluptatibus, impedit sed! Necessitatibus repellendus sed deleniti id et!"</em></p>
                        ...
                        <li class="feature-item">
                            <div class="left-icon">
                                <img src="{{ asset('car/images/features-first-icon.png') }}" alt="training fifth">
                            </div>
                            <div class="right-content">
                                <h4>John Doe</h4>
                                <p><em>"Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dicta numquam maxime voluptatibus, impedit sed! Necessitatibus repellendus sed deleniti id et!"</em></p>
